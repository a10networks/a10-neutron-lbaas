...
class CertificateExtensionTestCase(base.ExtensionTestCase):
    ...
    def setUp(self):
        ...
        self._setUpExtension(
            ...
            certificate.A10Certificate, '', supported_extension_aliases='a10-certificates'
        )
    ...
    def test_create_certificate(self):
        ...
        self.plugin.create_a10_certificate = mock.Mock(return_value=expected["a10_certificate"])
    ...
    def test_update_certificate(self):
        certificate_id = uuidutils.generate_uuid()
        expected = {'a10_certificate': self._build_test_certificate(tenant_id=None)}

        self.plugin.update_a10_certificate = mock.Mock(return_value=expected)
        self.api.put(_get_path("a10_certificates", id=certificate_id, fmt=self.fmt),
    ...
    def test_get_certificate(self):
        ...
        self.plugin.get_a10_certificate = mock.Mock(return_value=expected['a10_certificate'])
    ...
    def test_get_certificates(self):
        ...
        self.plugin.get_a10_certificates = mock.Mock(return_value=expected['a10_certificates'])
        url = _get_path("a10_certificates", fmt=self.fmt)
        ...
        self.plugin.get_a10_certificates.assert_called_with(mock.ANY,
                                                            ...
                                                            filters=mock.ANY)
        actual = self.deserialize(response)
        self.assertEqual(expected['a10_certificates'], actual['a10_certificates'])
    ...
    def test_get_certificate_bindings(self):
        ...
        self.plugin.get_a10_certificate_bindings = mock.Mock(
            return_value=expected['certificate_bindings'])
    ...
    def test_create_certificate_binding(self):
        certificate_id = uuidutils.generate_uuid()
        vip_id = uuidutils.generate_uuid()
        expected = {'a10_certificate_binding': self._build_test_binding(certificate_id, vip_id)}

        self.plugin.create_a10_certificate_binding = mock.Mock(return_value=expected)
        url = _get_path("a10-certificate-bindings", fmt=self.fmt)
    ...
    def test_delete_certificate_binding(self):
        binding_id = uuidutils.generate_uuid()
        url = _get_path("a10_certificate_bindings", id=binding_id, fmt=self.fmt)
